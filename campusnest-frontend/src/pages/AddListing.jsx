...
const AddListing = () => {
  ...
  const handleSubmit = async () => {
    if (!user || user.role !== "owner") {
      setError("Only owners can add listings!");
      return;
    }
  ...
  return (
    <div className="container" style={{ padding: "40px 20px", maxWidth: "800px" }}>
      ...
      <div className="card" style={{ marginBottom: "24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "16px" }}>
          <div className="form-group">
            ...
            <input
              type="text"
              placeholder="e.g. Green House Boarding"
              value={formData.name}
          ...
          <div className="form-group">
            ...
            <input
              type="number"
              placeholder="Max 10km"
              value={formData.distanceFromUniversityKm}
              onChange={(e) => setFormData({ ...formData, distanceFromUniversityKm: e.target.value })}
            />
          </div>
          <div className="form-group">
            <label>Address</label>
      ...
      {/* Payment + Advance */}
      <div className="card" style={{ marginBottom: "24px" }}>
        <h3 style={{ color: "var(--accent)", marginBottom: "16px" }}>💰 Payment & Advance</h3>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "16px" }}>
          <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    payment: { ...formData.payment, advancePayment: e.target.value },
                  })
                }
              />
            </div>
            ...
            onChange={(e) =>
              setFormData({
                ...
                furnishing: {
                  ...
                  items: e.target.value === "true" ? formData.furnishing.items : [],
                },
              })
            }
          >
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  rules: { ...formData.rules, petsAllowed: e.target.value === "true" },
                })
              }
            >
              <option value="false">❌ No</option>
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  rules: { ...formData.rules, visitorsAllowed: e.target.value === "true" },
                })
              }
            >
              <option value="false">❌ No</option>
      ...
      {/* Facilities */}
      <div className="card" style={{ marginBottom: "24px" }}>
        <h3 style={{ color: "var(--accent)", marginBottom: "16px" }}>🏪 Nearby Facilities</h3>
        ...
        >
          ...
          <div className="form-group" style={{ margin: 0 }}>
            ...
            <select
              ...
              onChange={(e) =>
                setFormData({ ...formData, noBarsOrClubs: e.target.value === "true" })
              }
            >
